...
wget -nv -O docker-compose.yaml https://raw.githubusercontent.com/PokimaneSafety/minecraft-server/main/docker-compose.yaml
wget -nv -O nginx.conf https://raw.githubusercontent.com/PokimaneSafety/minecraft-server/main/nginx.conf
