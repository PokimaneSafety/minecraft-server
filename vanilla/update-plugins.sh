...
wget -nv -O vanilla/plugins/1997.jar https://ci.dmulloy2.net/job/ProtocolLib/lastSuccessfulBuild/artifact/target/ProtocolLib.jar

# Server Backup
# https://www.spigotmc.org/resources/world-server-backup-1-8-1-18-x-multithreaded.79320/
wget -nv -O vanilla/plugins/79320.jar https://server-backup.net/assets/downloads/ServerBackup.jar
